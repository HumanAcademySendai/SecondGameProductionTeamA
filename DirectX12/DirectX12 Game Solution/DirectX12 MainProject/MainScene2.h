...
class MainScene2 final : public Scene {
public:
    MainScene2();
    virtual ~MainScene2() { Terminate(); }

    MainScene2(MainScene2&&) = default;
    MainScene2& operator= (MainScene2&&) = default;

    MainScene2(MainScene2 const&) = delete;
    MainScene2& operator= (MainScene2 const&) = delete;
