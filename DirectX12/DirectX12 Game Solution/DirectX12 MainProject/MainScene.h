...
private:
    ...
    const float DOOR_SCROLL_SPEED_X     = -600.0f;
    ...
    //下降のスピードと座標
    const float DOOR_DOWN_MOVE_SPEED_Y              = 300.0f;
    const float DOOR_SLOWDOWN_MOVE_START_POSITOIN_Y = -250.0f;
    const float DOOR_SLOWDOWN_MOVE_SPEED_Y          = 80.0f;
    const float DOOR_DOWN_MOVE_START_POSITOIN_X     = 1280.0f;
    ...
    const float DOOR_UP_MOVE_SPEED_Y     = -200.0f;
    ...
    const float ROCK_SCROLL_SPEED_X   = -600.0f;
    ...
    const float ARROW_LEFT_SCROLL_SPEED_X = -1800.0f;
    ...
    const float ARROW_DOWN_SCROLL_SPEED_X   = -600.0f;
    ...
    const float BAT_SCROLL_SPPED_X   = -1000.0f;
    ...
    const float FAKE_BAT_RIGHT_SCROLL_SPEED_X     = 500.0f;
    //演出コウモリ(左向き)
    ...
    const float JEWELRY_START_POSITION_X_12 = 16532.0f;
    const float JEWELRY_START_POSITION_X_13 = 16640.0f;
    const float JEWELRY_START_POSITION_X_14 = 16762.0f;
    const float JEWELRY_START_POSITION_X_15 = 17135.0f;
    const float JEWELRY_START_POSITION_X_16 = 17243.0f;
    const float JEWELRY_START_POSITION_X_17 = 17365.0f;
    const float JEWELRY_START_POSITION_X_18 = 17765.0f;
    const float JEWELRY_START_POSITION_X_19 = 17918.0f;
    const float JEWELRY_START_POSITION_X_20 = 18098.0f;
    const float JEWELRY_START_POSITION_X_21 = 18226.0f;
    const float JEWELRY_START_POSITION_X_22 = 18511.0f;
    const float JEWELRY_START_POSITION_X_23 = 18659.0f;
    const float JEWELRY_START_POSITION_X_24 = 18781.0f;
    const float JEWELRY_START_POSITION_X_25 = 19170.0f;
    const float JEWELRY_START_POSITION_X_26 = 19278.0f;
    const float JEWELRY_START_POSITION_X_27 = 19400.0f;
    const float JEWELRY_START_POSITION_X_28 = 19779.0f;
    const float JEWELRY_START_POSITION_X_29 = 19932.0f;
    const float JEWELRY_START_POSITION_X_30 = 20112.0f;
    const float JEWELRY_START_POSITION_X_31 = 20240.0f;

    const float JEWELRY_START_POSITION_Y_1  = 590.0f;
    const float JEWELRY_START_POSITION_Y_2  = 590.0f;
    const float JEWELRY_START_POSITION_Y_3  = 590.0f;
    ...
    const float JEWELRY_START_POSITION_Y_8  = 580.0f;
    const float JEWELRY_START_POSITION_Y_9  = 580.0f;
    const float JEWELRY_START_POSITION_Y_10 = 250.0f;
    const float JEWELRY_START_POSITION_Y_11 = 250.0f;
    const float JEWELRY_START_POSITION_Y_12 = 344.0f;
    const float JEWELRY_START_POSITION_Y_13 = 276.0f;
    const float JEWELRY_START_POSITION_Y_14 = 280.0f;
    const float JEWELRY_START_POSITION_Y_15 = 269.0f;
    const float JEWELRY_START_POSITION_Y_16 = 201.0f;
    const float JEWELRY_START_POSITION_Y_17 = 205.0f;
    const float JEWELRY_START_POSITION_Y_18 = 200.0f;
    const float JEWELRY_START_POSITION_Y_19 = 122.0f;
    const float JEWELRY_START_POSITION_Y_20 = 164.0f;
    const float JEWELRY_START_POSITION_Y_21 = 305.0f;
    const float JEWELRY_START_POSITION_Y_22 = 408.0f;
    const float JEWELRY_START_POSITION_Y_23 = 340.0f;
    const float JEWELRY_START_POSITION_Y_24 = 344.0f;
    const float JEWELRY_START_POSITION_Y_25 = 323.0f;
    const float JEWELRY_START_POSITION_Y_26 = 255.0f;
    const float JEWELRY_START_POSITION_Y_27 = 259.0f;
    const float JEWELRY_START_POSITION_Y_28 = 235.0f;
    const float JEWELRY_START_POSITION_Y_29 = 157.0f;
    const float JEWELRY_START_POSITION_Y_30 = 199.0f;
    const float JEWELRY_START_POSITION_Y_31 = 340.0f;

    const float JEWELRY_START_POSITION_Z = 11.0f;
    const float JEWELRY_SCROLL_SPEED_X   = -600.0f;
    ...
    const float HOLE_SCROLL_SPPED_X   = -600.0f;
...
private:
    ...
    void DownDoorUpdate      (const float deltaTime);
    void UpDoorUpdate        (const float deltaTime);
