...
private:
    ...
    const float JEWELRY_START_POSITION_X_12 = 16550.0f;
    const float JEWELRY_START_POSITION_X_13 = 16750.0f;
    const float JEWELRY_START_POSITION_X_14 = 17150.0f;
    const float JEWELRY_START_POSITION_X_15 = 17350.0f;
    ...
    const float JEWELRY_START_POSITION_X_19 = 18580.0f;
    const float JEWELRY_START_POSITION_X_20 = 18800.0f;
    const float JEWELRY_START_POSITION_X_21 = 19200.0f;
    const float JEWELRY_START_POSITION_X_22 = 19400.0f;
    const float JEWELRY_START_POSITION_X_23 = 19925.0f;
    const float JEWELRY_START_POSITION_X_24 = 20125.0f;
    const float JEWELRY_START_POSITION_X_25 = 21600.0f;
    const float JEWELRY_START_POSITION_X_26 = 21800.0f;
    const float JEWELRY_START_POSITION_X_27 = 24000.0f;
    const float JEWELRY_START_POSITION_X_28 = 24200.0f;
    const float JEWELRY_START_POSITION_X_29 = 29550.0f;
    const float JEWELRY_START_POSITION_X_30 = 29650.0f;
    const float JEWELRY_START_POSITION_X_31 = 29750.0f;
    ...
    const float JEWELRY_START_POSITION_Y_12 = 320.0f;
    const float JEWELRY_START_POSITION_Y_13 = 250.0f;
    const float JEWELRY_START_POSITION_Y_14 = 270.0f;
    const float JEWELRY_START_POSITION_Y_15 = 200.0f;
    const float JEWELRY_START_POSITION_Y_16 = 220.0f;
    const float JEWELRY_START_POSITION_Y_17 = 180.0f;
    const float JEWELRY_START_POSITION_Y_18 = 330.0f;
    const float JEWELRY_START_POSITION_Y_19 = 350.0f;
    const float JEWELRY_START_POSITION_Y_20 = 270.0f;
    const float JEWELRY_START_POSITION_Y_21 = 290.0f;
    const float JEWELRY_START_POSITION_Y_22 = 200.0f;
    const float JEWELRY_START_POSITION_Y_23 = 100.0f;
    const float JEWELRY_START_POSITION_Y_24 = 200.0f;
    const float JEWELRY_START_POSITION_Y_25 = 400.0f;
    const float JEWELRY_START_POSITION_Y_26 = 400.0f;
    const float JEWELRY_START_POSITION_Y_27 = 400.0f;
    const float JEWELRY_START_POSITION_Y_28 = 400.0f;
    const float JEWELRY_START_POSITION_Y_29 = 200.0f;
    const float JEWELRY_START_POSITION_Y_30 = 300.0f;
    const float JEWELRY_START_POSITION_Y_31 = 500.0f;
